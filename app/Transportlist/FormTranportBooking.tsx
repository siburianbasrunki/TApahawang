...
const FormTransportBooking: React.FC<FormTransportBookingProps> = ({ selectedTransport }) => {
            ...
            <div className={isOpen ? "modal modal-open" : "modal"}>
                <div className="modal-box bg-white rounded-md p-8">
                    <div className="flex justify-between items-center mb-4">
                        <h3 className="font-bold text-2xl">Formulir Booking Transportasi</h3>
                        <button
                    ...
                    <form>
                        ...
                        <div className="form-control">
                            ...
                            <input type="date" id="checkIn" className="input input-bordered" />
                        </div>
                        ...
                        <div className="form-control">
                            ...
                            <div className="file-input-wrapper">
                                <input type="file" id="buktiPembayaran" className="file-input" />
                            </div>
                        </div>

                        <div className="modal-action mt-6">
                            <button type="button" className="btn btn-secondary mr-2" onClick={handleModal}>
                                Tutup
                            </button>
