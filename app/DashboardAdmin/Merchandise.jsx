    ...
    <div>
      ...
      <div className="overflow-x-auto">
        <table className="min-w-full">
          ...
          <tbody>
            {/* Isi data Merchandise dari database */}
            <tr>
              ...
              <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">Kaos Keren</td>
              <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">3</td>
